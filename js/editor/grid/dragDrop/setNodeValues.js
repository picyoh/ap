...
export const setNodeValues = (values, dataClass, newElement) => {
  ...
  if (dataClass === "question__input") {
    ...
    const currentQuestionLink =
      questionNodes[0].parentNode.parentNode.firstElementChild;
    // create new path
    //TODO: setStart and set End
    getElementPositions(parentLinkElement, "start");
    getElementPositions(currentQuestionLink, "end");
    createPath(parentElement, currentQuestion);
  }
